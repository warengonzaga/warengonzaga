...
1. 🚀 Published release [v1.0.0-beta.2](https://github.com/wgtechlabs/unthread-telegram-bot/releases/tag/v1.0.0-beta.2) in [wgtechlabs/unthread-telegram-bot](https://github.com/wgtechlabs/unthread-telegram-bot)
2. 🎉 Merged PR [#24](https://github.com/wgtechlabs/unthread-telegram-bot/pull/24) in [wgtechlabs/unthread-telegram-bot](https://github.com/wgtechlabs/unthread-telegram-bot)
3. 🚀 Published release [v1.0.0-beta.4](https://github.com/wgtechlabs/unthread-webhook-server/releases/tag/v1.0.0-beta.4) in [wgtechlabs/unthread-webhook-server](https://github.com/wgtechlabs/unthread-webhook-server)
4. 🎉 Merged PR [#6](https://github.com/wgtechlabs/unthread-webhook-server/pull/6) in [wgtechlabs/unthread-webhook-server](https://github.com/wgtechlabs/unthread-webhook-server)
5. 💪 Opened PR [#6](https://github.com/wgtechlabs/unthread-webhook-server/pull/6) in [wgtechlabs/unthread-webhook-server](https://github.com/wgtechlabs/unthread-webhook-server)
